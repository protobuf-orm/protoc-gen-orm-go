...
const file_apptest_user_proto_rawDesc = "" +
	"\n" +
	"\x12apptest/user.proto\x12\aapptest\x1a\x14apptest/tenant.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\torm.proto\"\xfe\x02\n" +
	"\x04User\x12\x1d\n" +
	"\x02id\x18\x01 \x01(\fB\r\xea\x82\x16\x04\x10@(\x01\xaa\x01\x02\b\x02R\x02id\x12-\n" +
	"\x06tenant\x18\x02 \x01(\v2\x0f.apptest.TenantB\x04\xf2\x82\x16\x00R\x06tenant\x12\"\n" +
	...
	"\n" +
	"\x06tenant\x10\x020\x01B<Z:github.com/protobuf-orm/protoc-gen-orm-go/internal/apptestb\beditionsp\xe8\a"
